                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(['class' => 'form-horizontal']) !!}
                                ...
                                <div class="form-group{{ $errors->has('last_name') || $errors->has('first_name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        {!! Form::text('last_name', $row->last_name, ['required', 'class' => 'form-control ckeditor', 'placeholder' => '姓']) !!}
                                    ...
                                    <div class="col-md-3">
                                        {!! Form::text('first_name', $row->first_name, ['required', 'class' => 'form-control ckeditor', 'placeholder' => '名']) !!}
                                ...
                                <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::text('department', $row->department, ['class' => 'form-control ckeditor', 'placeholder' => '']) !!}
